...
2. Run `npm start`. The zero-dependency preview server binds to all interfaces, so browser-based workspaces can expose a preview without installing packages.
